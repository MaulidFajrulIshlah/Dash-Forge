...
function replaceTokenInFile(filePath, newToken) {
    ...
    fs.readFile(filePath, "utf8", (err, data) => {
        ...
        const newData = data.replace(/wstoken='+tokenApi+'/g, 'wstoken='+newToken);
...
// Contoh penggunaan
const folderPath = "D:/Magang/dashboard-monitoring/public/js"; // Ganti dengan path folder JS kamu
